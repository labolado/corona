...
then
	...
	if convert sdk/dmg/CoronaBackground.png -pointsize 13 -stroke DarkGrey -fill DarkGrey -draw "text 39,387 '$FULL_BUILD_NUM'" "$TMPBACKGROUND"
	then
		...
		echo "WARNING: ImageMagick convert annotation failed (missing fonts), building DMG without build number on background"
