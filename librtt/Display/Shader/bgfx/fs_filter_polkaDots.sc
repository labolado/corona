$input v_TexCoord, v_ColorScale, v_UserData, v_slot_size, v_sample_uv_offset, v_minimum_full_radius, v_MaskUV0, v_MaskUV1, v_MaskUV2
...
void main()
{
    ...
    vec4 _masked = color * v_ColorScale * visibility * brightness;
    if (u_TexFlags.y > 0.5)
